...
public class HeavyIonOnFireEffect implements OnFireEffectPlugin {
    @Override
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        LanceBeam.spawnLanceBeam(engine, projectile.getSpawnLocation(), weapon.getCurrAngle(), weapon.getRange(), scaleVector(weapon.getShip().getVelocity(), 0.8f),
                coreSprite, new Color(230, 230, 255), new Color(200, 255, 255), null, 7, 5, 1.8f, 64, -100, 1, 0.9f, 0, 0.4f, 0.2f,
                fringeSprite, new Color(68, 134, 255), new Color(152, 255, 238), new Color(76, 38, 255), 9, 6, 2, 100, 0, 1, 0.8f, 0.1f, 0.4f, 0.2f,
