...
public class BanefireOnFireEffect implements OnFireEffectPlugin {
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        SpriteAPI coreSprite = Global.getSettings().getSprite("fx", "trail_opaque");
        SpriteAPI fringeSprite = Global.getSettings().getSprite("fx", "trail_opaque");
        /*
        LanceBeam.spawnLanceBeam(engine, projectile.getSpawnLocation(), weapon.getCurrAngle(), weapon.getRange(), scaleVector(weapon.getShip().getVelocity(), 0.8f),
                coreSprite, new Color(230, 230, 255), new Color(255, 255, 200), new Color(255, 200, 200), 5, 6, 0.3f, 100, 0, 1, 1, 0, 3f, 0.1f,
                fringeSprite, new Color(255, 34, 93), new Color(255, 0, 0), new Color(148, 36, 12), 9, 12, 2, 100, 0, 1, 1, 0, 3f, 0.2f,
                5, 80, projectile.getDamageAmount(), projectile.getDamageType(), projectile.getEmpAmount(), 100, 0, weapon.getShip(), false, false, null);
        */
        //MagicFakeBeam.spawnFakeBeam(engine, projectile.getSpawnLocation(), weapon.getRange(), weapon.getCurrAngle(), 20, 1, 0.5f, 40, new Color(230, 230, 255), new Color(255, 34, 93), 100, DamageType.ENERGY, 0, weapon.getShip() );
        MagicFakeBeam.spawnAdvancedFakeBeam(engine, projectile.getSpawnLocation(), 1000, weapon.getCurrAngle(), 20, 20, 0, "trail_opaque", "base_trail_zapWithCore", 100, 1, 5, 5, 1, 0.5f, 20, new Color(230, 230, 255), new Color(255, 34, 93), 100, DamageType.ENERGY, 0, weapon.getShip());
