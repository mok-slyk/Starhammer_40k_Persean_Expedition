...
public class Novacannon extends BaseHullMod {
    public final String DEFAULT_STATS_ID = "shpe_marsnova";
    public final String PREFIX = "shpe_";
    public final String SUFFIX = "_reference";
    public final Set<String> VALID_IDS = new HashSet<>(Arrays.asList("shpe_ryza_cannon","shpe_jovian_cannon","shpe_lathe_cannon"));
    public final int MAX_SLOT_COUNT = 3; //last slot: BIT23
    ...
    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        ...
        switch (relevantHullmodID) {
            case "shpe_ryza_cannon":
                weaponSpecID = "shpe_ryzanova";
                break;
            case "shpe_jovian_cannon":
                weaponSpecID = "shpe_joviannova";
                break;
            case "shpe_lathe_cannon":
                weaponSpecID = "shpe_lathenova";
                break;
            default:
