...
public class LanceBeamPlugin2 extends BaseEveryFrameCombatPlugin {
    ...
    public static LanceBeamPlugin2 getPlugin() {
        CombatEngineAPI engine = Global.getCombatEngine();
        if (engine == null) {
            return null;
        }
        return (LanceBeamPlugin2) engine.getCustomData().get(KEY);
    }
...
class LanceBeamRenderer extends BaseCombatLayeredRenderingPlugin {
    private LanceBeamPlugin2 parent;
    ...
    protected LanceBeamRenderer(LanceBeamPlugin2 parent) {
        this.parent = parent;
    }
    @Override
